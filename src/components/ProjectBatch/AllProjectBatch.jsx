...
const AllProjectBatch = () => {
  ...
  const getStatusData = () => {
    const statusCounts = filteredProjects.reduce((acc, project) => {
      // Convert all non-"Completed" statuses to "Pending"
        ...
        {filteredProjects.length > 0 && (
          <div className="bg-gray-800 rounded-xl border border-gray-700 shadow-xl p-6 mb-8 max-w-3xl mx-auto">
            <h2 className="text-xl font-semibold text-blue-400 mb-4 flex items-center gap-3">
              <PieChartIcon className="w-6 h-6 text-blue-400" /> Project Analytics
            </h2>
            <div className="bg-gray-700/50 p-4 rounded-xl border border-gray-600">
              <h3 className="text-lg font-semibold mb-2 flex items-center gap-2">
                <CheckCircle2 className="w-5 h-5 text-blue-400" /> Project Completion Status
              </h3>
                ...
                >
                  ...
                  <div className="space-y-3 mb-4">
                    ...
                    <p className="text-sm  ">
                      ...
                      <span 
                        className={`px-2 py-1 rounded-full text-xs flex items-center gap-1 inline-flex ${
